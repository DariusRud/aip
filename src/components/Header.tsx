...
const Header: React.FC<HeaderProps> = ({ currentDate, userEmail, userRole, onLogout }) => {
  ...
  return (
    // PATAISYMAS: Pridėta 'relative' ir padidintas z-index į 'z-30', kad būtų aukščiau turinio
                ...
                <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-slate-200 overflow-hidden z-50">
                  ...
                  <div className="py-2">
                    <a
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        alert('Profilio nustatymai (bus pridėta vėliau)');
                        setIsDropdownOpen(false);
                      }}
